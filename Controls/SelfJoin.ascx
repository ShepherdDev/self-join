                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <Rock:GroupPicker ID="gpSettingsGroup" runat="server" Label="Group" Help="The group to use as a root for showing selections. This is passed to the Lava parser as a property called Group and can be used to build the list of checkboxes or radio buttons." OnSelectItem="gpSettingsGroup_SelectItem" />
                                            <Rock:GroupRolePicker ID="grpSettingsRole" runat="server" Label="Role" Help="The group role to use when adding new members to the group. If the group does not have this role then the default role will be used instead." Visible="false" />
